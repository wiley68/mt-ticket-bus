...
class MT_Ticket_Bus_Routes
{
    ...
    public function get_all_routes($args = array())
    {
        ...
        // phpcs:disable WordPress.DB.PreparedSQL.InterpolatedNotPrepared, WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching -- Custom plugin table; no core API. Table/column names cannot be parameterized.
        if ($args['status'] !== 'all') {
