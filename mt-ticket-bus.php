 ...
 * @since 1.0.0
 */
define('MT_TICKET_BUS_VERSION', '1.0.16');
 ...
 * @since 1.0.0
 */
define('MT_TICKET_BUS_DB_VERSION', '1.0.4');
 ...
 * @since 1.0.11
 */
define('MT_TICKET_BUS_PLUGIN_FILE', __FILE__);
...
<?php
    ...
    private function includes()
    {
        ...
        require_once MT_TICKET_BUS_PLUGIN_DIR . 'includes/class-extras.php';
        require_once MT_TICKET_BUS_PLUGIN_DIR . 'includes/class-woocommerce-integration.php';
        require_once MT_TICKET_BUS_PLUGIN_DIR . 'includes/class-appearance-palettes.php';
