...
<div class="wrap mt-ticket-bus-overview">
    ...
    <div class="mt-ticket-bus-dashboard">
        <div class="mt-dashboard-widgets">
            ...
            <div class="mt-widget mt-widget-status">
                <h3><?php esc_html_e('Status', 'mt-ticket-bus'); ?></h3>
                <?php
                ...
                <div class="mt-license-form">
                    <label for="mt_ticket_bus_license_key" class="mt-license-label">
                        <?php esc_html_e('Activation key', 'mt-ticket-bus'); ?>
                    </label>
                    <div class="mt-license-controls">
                        <input
                            type="text"
                            id="mt_ticket_bus_license_key"
                            class="regular-text"
                    ...
                    <p class="description mt-license-help">
                        <?php esc_html_e('Activate Pro features for this site.', 'mt-ticket-bus'); ?>
                    </p>
                    <div class="mt-license-message" id="mt_ticket_bus_license_message" aria-live="polite"></div>
                </div>
            </div>

            <div class="mt-widget-group">
                <div class="mt-widget mt-widget-half">
